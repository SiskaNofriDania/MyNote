...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView buatCatatanBaru = findViewById(R.id.tambah);
        ...
        isiCatatan.setText(i.getStringExtra("note"));
        ...
        simpanCatatan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (judulCatatan.getText().toString().isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Judul tidak boleh kosong",
                            Toast.LENGTH_SHORT).show();
                    return;
                }
                if (isiCatatan.getText().toString().isEmpty()) {
                    Toast.makeText(getApplicationContext(), "Isi catatan tidak boleh kosong",
                            Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (masukkanCatatan) {
                    Toast.makeText(getApplicationContext(), "note berhasil disimpan", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void dialogDaftarCatatan () {
        ...
        View v = inflater.inflate(R.layout.layout_daftar_note, null);
        ...
        hapusSemuaCatatan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(), "Seluruh note dihapus", Toast.LENGTH_SHORT).show();
            }
        });
